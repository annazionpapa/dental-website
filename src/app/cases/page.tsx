              ...
              {filteredCases.map((caseItem) => (
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-100 hover:border-teal/20 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    {/* 카드 상단 이미지 placeholder */}
                    <div className="h-48 bg-gradient-to-br from-teal/5 to-sky-light flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-teal/10 rounded-full mx-auto mb-2 flex items-center justify-center group-hover:bg-teal/20 transition-colors">
                          <svg
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-400">{caseItem.year}년</span>
